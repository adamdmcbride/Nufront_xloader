...
{
// configuration for k4b2g0846d_k0, frequency is 333, 
// cl is 5, bl is 8, cs0 is enable 
REG_WRITE(DDR_BASE_ADDR + 0x0, 0x00000600);
REG_WRITE(DDR_BASE_ADDR + 0x8, 0x00000004);
REG_WRITE(DDR_BASE_ADDR + 0x18, 0x0001046b);
REG_WRITE(DDR_BASE_ADDR + 0x1c, 0x00028b0b);
REG_WRITE(DDR_BASE_ADDR + 0x20, 0x0404050a);
REG_WRITE(DDR_BASE_ADDR + 0x24, 0x040c1104);
REG_WRITE(DDR_BASE_ADDR + 0x28, 0x0c040405);
REG_WRITE(DDR_BASE_ADDR + 0x2c, 0x03005b68);
REG_WRITE(DDR_BASE_ADDR + 0x30, 0x01000004);
REG_WRITE(DDR_BASE_ADDR + 0x34, 0x0a050501);
REG_WRITE(DDR_BASE_ADDR + 0x38, 0x050a0300);
REG_WRITE(DDR_BASE_ADDR + 0x40, 0x00003601);
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000a24);
REG_WRITE(DDR_BASE_ADDR + 0x48, 0x000a0003);
REG_WRITE(DDR_BASE_ADDR + 0x4c, 0x00390200);
REG_WRITE(DDR_BASE_ADDR + 0x50, 0x00010000);
REG_WRITE(DDR_BASE_ADDR + 0x54, 0x00050500);
REG_WRITE(DDR_BASE_ADDR + 0x78, 0x00460210);
REG_WRITE(DDR_BASE_ADDR + 0x84, 0x00021000);
...
REG_WRITE(DDR_BASE_ADDR + 0x10c, 0x01020201);
...
REG_WRITE(DDR_BASE_ADDR + 0x144, 0x00001b00);  //modify 
REG_WRITE(DDR_BASE_ADDR + 0x148, 0x00000019);  //modify 
REG_WRITE(DDR_BASE_ADDR + 0x154, 0x001b001a);  //modify 
REG_WRITE(DDR_BASE_ADDR + 0x160, 0x00001b00);  //modify 
REG_WRITE(DDR_BASE_ADDR + 0x164, 0x0000001c);  //modify 
REG_WRITE(DDR_BASE_ADDR + 0x170, 0x001a001e);  //modify 
REG_WRITE(DDR_BASE_ADDR + 0x174, 0x08085555);
REG_WRITE(DDR_BASE_ADDR + 0x180, 0x00000700);
REG_WRITE(DDR_BASE_ADDR + 0x184, 0x000a2400);
REG_WRITE(DDR_BASE_ADDR + 0x188, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x18c, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x190, 0x00000a24);
REG_WRITE(DDR_BASE_ADDR + 0x194, 0x000032b4);
REG_WRITE(DDR_BASE_ADDR + 0x198, 0x00020505);
...
REG_WRITE(DDR_BASE_ADDR + 0x210, 0x00002700);  //modify from 20 to 27
...
REG_WRITE(DDR_BASE_ADDR + 0x250, 0x00002700);  //modify from 20 to 27
...
REG_WRITE(DDR_BASE_ADDR + 0x290, 0x00002b00);  //modify from 20 to 2b
...
REG_WRITE(DDR_BASE_ADDR + 0x2d0, 0x00002d00);  //modify from 20 to 2d
