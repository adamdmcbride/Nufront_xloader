#include "dw_ddr.h"
jedec_ddr3_4g_x16_1333h_cs0_freq333_cl5_bl8()
{
// configuration for jedec_ddr3_4g_x16_1333h, frequency is 333, 
...
REG_WRITE(DDR_BASE_ADDR + 0x40, 0x00006401);
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000a20);
REG_WRITE(DDR_BASE_ADDR + 0x48, 0x000a0003);
REG_WRITE(DDR_BASE_ADDR + 0x4c, 0x00680200);
