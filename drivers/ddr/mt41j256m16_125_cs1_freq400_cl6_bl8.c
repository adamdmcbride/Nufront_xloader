...
{
// configuration for mt41j256m16_125, frequency is 400, 
// cl is 6, bl is 8, cs1 is enabled 
...
REG_WRITE(DDR_BASE_ADDR + 0x40, 0x00006801);
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000c2d);
REG_WRITE(DDR_BASE_ADDR + 0x48, 0x000a0003);
REG_WRITE(DDR_BASE_ADDR + 0x4c, 0x006c0200);
