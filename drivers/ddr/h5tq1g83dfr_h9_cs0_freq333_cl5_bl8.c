#include "dw_ddr.h"
h5tq1g83dfr_h9_cs0_freq333_cl5_bl8()
{
// configuration for h5tq1g83dfr_h9, frequency is 333, 
...
REG_WRITE(DDR_BASE_ADDR + 0x40, 0x00002501);
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000a20);
REG_WRITE(DDR_BASE_ADDR + 0x48, 0x000a0003);
REG_WRITE(DDR_BASE_ADDR + 0x4c, 0x00280200);
