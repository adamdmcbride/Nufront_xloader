...
{
// configuration for edj2116debg_dj, frequency is 333, 
...
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x0000050e);
...
REG_WRITE(DDR_BASE_ADDR + 0x184, 0x00050e00);
REG_WRITE(DDR_BASE_ADDR + 0x188, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x18c, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x190, 0x0000050e);
REG_WRITE(DDR_BASE_ADDR + 0x194, 0x00001946);
