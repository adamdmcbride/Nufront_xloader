...
{
// configuration for k4b2g0846d_k0, frequency is 400, 
...
REG_WRITE(DDR_BASE_ADDR + 0x24, 0x040e1404);
...
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000c2d);
...
REG_WRITE(DDR_BASE_ADDR + 0x144, 0x00001900);//modify 
REG_WRITE(DDR_BASE_ADDR + 0x148, 0x00000019);//modify 
REG_WRITE(DDR_BASE_ADDR + 0x154, 0x001b001b);//modify 
REG_WRITE(DDR_BASE_ADDR + 0x160, 0x00001b00);//modify 
REG_WRITE(DDR_BASE_ADDR + 0x164, 0x0000001b);//modify 
REG_WRITE(DDR_BASE_ADDR + 0x170, 0x0019001b);//modify 
REG_WRITE(DDR_BASE_ADDR + 0x174, 0x08085555);
REG_WRITE(DDR_BASE_ADDR + 0x180, 0x00000700);
REG_WRITE(DDR_BASE_ADDR + 0x184, 0x000c2d00);
REG_WRITE(DDR_BASE_ADDR + 0x188, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x18c, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x190, 0x00000c2d);
REG_WRITE(DDR_BASE_ADDR + 0x194, 0x00003ce1);
...
REG_WRITE(DDR_BASE_ADDR + 0x210, 0x00002b00);//modify 
...
REG_WRITE(DDR_BASE_ADDR + 0x250, 0x00002b00);//modify 
...
REG_WRITE(DDR_BASE_ADDR + 0x290, 0x00002b00);//modify 
...
REG_WRITE(DDR_BASE_ADDR + 0x2d0, 0x00002b00);//modify 
