#include "dw_ddr.h"
jedec_ddr3_4g_x16_1333h_cs0_freq400_cl6_bl8()
{
// configuration for jedec_ddr3_4g_x16_1333h, frequency is 400, 
...
REG_WRITE(DDR_BASE_ADDR + 0x38, 0x06120300);
REG_WRITE(DDR_BASE_ADDR + 0x40, 0x00007801);
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000c28);
REG_WRITE(DDR_BASE_ADDR + 0x48, 0x000a0003);
REG_WRITE(DDR_BASE_ADDR + 0x4c, 0x007c0200);
