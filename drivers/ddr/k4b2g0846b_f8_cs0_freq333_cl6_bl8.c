#include "dw_ddr.h"
k4b2g0846b_f8_cs0_freq333_cl6_bl8()
{
// configuration for k4b2g0846b_f8, frequency is 333, 
...
REG_WRITE(DDR_BASE_ADDR + 0x24, 0x040d1104);
...
REG_WRITE(DDR_BASE_ADDR + 0x38, 0x050d0300);
