#include "dw_ddr.h"
mt41j512m8_125_cs0_freq333_cl5_bl8()
{
// configuration for mt41j512m8_125, frequency is 333, 
// cl is 5, bl is 8, cs0 is enabled
...
REG_WRITE(DDR_BASE_ADDR + 0x40, 0x00005701);
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000a24);
REG_WRITE(DDR_BASE_ADDR + 0x48, 0x000a0003);
REG_WRITE(DDR_BASE_ADDR + 0x4c, 0x005a0200);
...
REG_WRITE(DDR_BASE_ADDR + 0x144, 0x00202000);
REG_WRITE(DDR_BASE_ADDR + 0x148, 0x00000001);
REG_WRITE(DDR_BASE_ADDR + 0x154, 0x00012020);
REG_WRITE(DDR_BASE_ADDR + 0x160, 0x00202000);
REG_WRITE(DDR_BASE_ADDR + 0x164, 0x00000001);
REG_WRITE(DDR_BASE_ADDR + 0x170, 0x00012020);
...
REG_WRITE(DDR_BASE_ADDR + 0x1e4, 0x01010000);
