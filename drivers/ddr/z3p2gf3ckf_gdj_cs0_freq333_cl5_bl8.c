#include "dw_ddr.h"
z3p2gf3ckf_gdj_cs0_freq333_cl5_bl8()
{
// configuration for z3p2gf3ckf_gdj, frequency is 333, 
...
REG_WRITE(DDR_BASE_ADDR + 0x24, 0x040d1204);
...
REG_WRITE(DDR_BASE_ADDR + 0x38, 0x050e0300);
REG_WRITE(DDR_BASE_ADDR + 0x40, 0x00003601);
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000a20);
...
REG_WRITE(DDR_BASE_ADDR + 0x184, 0x000a2000);
REG_WRITE(DDR_BASE_ADDR + 0x188, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x18c, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x190, 0x00000a20);
REG_WRITE(DDR_BASE_ADDR + 0x194, 0x000032a0);
...
REG_WRITE(DDR_BASE_ADDR + 0x344, 0x00001004);
