#include "dw_ddr.h"
jedec_ddr3_2g_x8_800e_cs0_freq333_cl5_bl8()
{
// configuration for jedec_ddr3_2g_x8_800e, frequency is 333, 
...
REG_WRITE(DDR_BASE_ADDR + 0x144, 0x00222200);
REG_WRITE(DDR_BASE_ADDR + 0x148, 0x00000001);
REG_WRITE(DDR_BASE_ADDR + 0x154, 0x00012222);
REG_WRITE(DDR_BASE_ADDR + 0x160, 0x00222200);
REG_WRITE(DDR_BASE_ADDR + 0x164, 0x00000001);
REG_WRITE(DDR_BASE_ADDR + 0x170, 0x00012222);
