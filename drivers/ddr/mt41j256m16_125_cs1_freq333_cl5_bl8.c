...
{
// configuration for mt41j256m16_125, frequency is 333, 
// cl is 5, bl is 8, cs1 is enabled 
...
REG_WRITE(DDR_BASE_ADDR + 0xc4, 0x00000c02);     //redefined
REG_WRITE(DDR_BASE_ADDR + 0xcc, 0x00000100);
REG_WRITE(DDR_BASE_ADDR + 0x104, 0x02000000);    //redefined
