...
{
// configuration for edj2116debg_dj, frequency is 400, 
...
REG_WRITE(DDR_BASE_ADDR + 0x44, 0x00000612);
...
REG_WRITE(DDR_BASE_ADDR + 0x184, 0x00061200);
REG_WRITE(DDR_BASE_ADDR + 0x188, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x18c, 0x02000200);
REG_WRITE(DDR_BASE_ADDR + 0x190, 0x00000612);
REG_WRITE(DDR_BASE_ADDR + 0x194, 0x00001e5a);
