...
#define SDMMC_CMD7			((7 | CMD) & ~CMD_CHECK_RESPONSE_CRC)
...
#define MMC_CLOCK_REFERENCE		(25)
#define MMC_RELATIVE_CARD_ADDRESS	(0x1234)
#define MMC_INIT_SEQ_CLK		(1)
#define MMC_400kHz_CLK			(((MMC_CLOCK_REFERENCE * 1000) / (2*400))-1)
//#define CLKDR(r, f, u)			((((r)*100) / ((f)*(u)*2)) - 1)
#define CLKDR(r, f, u)			((((r)*100) / ((f)*(u)*2)))
